...
class Transcribe:
    ...
    def transcribe(self, audio):
        ...
        try:
            hailo_segments = self.model.generate_all_segments(samples, task=Speech2TextTask.TRANSCRIBE, language=self.language, timeout_ms=self.timeout_ms)
        except Exception as exc:
        ...
        return Transcript(segments=segments, language=self.language or "unknown")
